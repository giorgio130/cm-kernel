...
static void htcleo_config_bt_init(void)
{
	...
	/* BT_RESET_N */
	gpio_direction_output(HTCLEO_GPIO_BT_RESET_N, GPIOF_OUTPUT_LOW);
	mdelay(2);
	/* BT_SHUTDOWN_N */
	gpio_direction_output(HTCLEO_GPIO_BT_SHUTDOWN_N, GPIOF_OUTPUT_LOW);
	mdelay(2);

	/* BT_CHIP_WAKE */
	gpio_direction_output(HTCLEO_GPIO_BT_CHIP_WAKE, GPIOF_OUTPUT_HIGH);
...
static void htcleo_config_bt_on(void)
{
	...
	/* BT_RESET_N */
	gpio_direction_output(HTCLEO_GPIO_BT_RESET_N, GPIOF_OUTPUT_HIGH);
	mdelay(2);
	/* BT_SHUTDOWN_N */
	gpio_direction_output(HTCLEO_GPIO_BT_SHUTDOWN_N, GPIOF_OUTPUT_HIGH);
	mdelay(2);
}
...
static void htcleo_config_bt_off(void)
{
	...
	/* BT_RTS */
	gpio_direction_output(HTCLEO_GPIO_BT_UART1_RTS, GPIOF_OUTPUT_LOW);
	/* BT_TX */
	gpio_direction_output(HTCLEO_GPIO_BT_UART1_TX, GPIOF_OUTPUT_LOW);

	/* BT_CHIP_WAKE */
	gpio_direction_output(HTCLEO_GPIO_BT_CHIP_WAKE, GPIOF_OUTPUT_LOW);
}
